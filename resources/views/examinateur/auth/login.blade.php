		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="{{ asset('img/auth/labo.svg') }}" alt="IMG">
				</div>

				<form class="login100-form validate-form" method="POST" action="{{ route('examinateur.login') }}" aria-label="{{ __('Login') }}">
					@csrf
					<span class="login100-form-title" style="font-size: 21px">
						Examinateur - Authentification
					</span>
