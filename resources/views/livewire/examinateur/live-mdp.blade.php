    ...
    <div class="card">
        <div class="card-block">
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="Veuillez saisir le mot de passe actuel" type="password" name="old_password" wire:model="old_password">
                @error('old_password') <span class="error" style="color: red;">{{ $message }}</span> @enderror
            </div>

            <div class="form-group">
                <label for="password" class="control-label">Nouveau mot de passe</label>
                <input class="form-control" placeholder="Veuillez saisir le nouveau mot de passe" type="password" name="password" wire:model="password">
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="Veuillez répéter le nouveau mot de passe" type="password" name="password_confirmation" wire:model="password_confirmation">
