                                ...
                                <table>
                                    <thead>
                                        <tr class="table100-head">
                                            ...
                                            <th class="column2">IMC</th>
                                            <th class="column3">Poid</th>
                                            <th class="column2">Taille</th>
                                            <th class="column1">Group sanguin</th>
                                        </tr>
                                    </thead>
                                    <tbody>
@php
...
@endphp
<tr>
    <td class="column1">{{$patient->date}}</td>
    <td class="column2">{{$biometrie->imc}}</td>
    <td class="column3">{{$biometrie->poids}}</td>
    <td class="column2">{{$biometrie->taille}}</td>
    <td class="column1">{{$biometrie->group_sanguin}}</td>
