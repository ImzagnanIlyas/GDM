                        ...
                        <div class="tab-pane active show" id="profile">
                                ...
                                <form>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label colo" style="">Motif</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="{{$id->motif}}" style="height:80px;" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label colo">Histoire</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="{{$id->histoire}}" style="height:80px;" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label colo ">Strategis diagnostic</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="{{$id->strategie_diagnostique}}" style="height:80px;" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label colo ">Diagnostic retenu</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="{{$id->diagnostic_retenu}}" style="height:80px;" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label colo">Compt rendu</label>
                                        <div class="col-lg-9">
