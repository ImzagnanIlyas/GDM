                    ...
                    <div class="row">
                        <div class="card car ">
                            ...
                            <table class="table">
                                <thead>
                                    <tr class="filters">
                                        <th><input type="text" class="form-control" placeholder="Date d'examen" disabled></th>
                                        <th><input type="text" class="form-control" placeholder="Nom d'examen" disabled></th>
                                        <th><input type="text" class="form-control" placeholder="Résultat" disabled></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$examen->nom}}</td>
                                        <td><a  class="disabled" href="{{route('Examenspecialise' ,[$examen->id])}}">Résultat</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
