    ...
    @elseif ( $resultat->type === 'pdf')
        ...
        <ul id="files">
            @foreach ( $resultat->pdf as $pdf )
                <li>
                    <a href="{{ route('medecin.consultation.ExamSpecialResultat.PDF', [ 'consultation_id' => Crypt::encrypt($consultation->id), 'examen_id' => Crypt::encrypt($examen->id), 'i' => $i ]) }}" target="_blank" class="file_link">
                        <div class="link_icon">
